...
const Hero = ({ onStartQuiz }: { onStartQuiz: () => void }) => (
  <section className="relative h-screen flex flex-col items-center justify-center text-center px-6 overflow-hidden bg-paper">
    ...
    >
      ...
      <button 
        onClick={onStartQuiz}
        className="group relative px-12 py-6 bg-ink text-paper rounded-full font-bold overflow-hidden transition-all hover:scale-105"
      >
  ...
  return (
    <section className="min-h-screen py-32 px-6 flex items-center justify-center bg-paper relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        <div className="absolute top-[-10%] left-[-10%] w-[50%] h-[50%] rounded-full bg-accent/5 blur-[120px]" />
      ...
      <div className="max-w-5xl w-full relative z-10">
        ...
        <AnimatePresence mode="wait">
          {state.step === 1 && (
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-12 max-w-5xl mx-auto">
                ...
                >
                  ...
                  <div className="absolute inset-0 flex flex-col items-center justify-end p-16 text-center space-y-6">
                    ...
                    <div className="w-12 h-px bg-paper/30 group-hover:w-24 transition-all duration-500" />
                    <p className="text-[9px] uppercase tracking-[0.4em] text-paper/60 group-hover:text-paper transition-colors font-bold">Select Path</p>
                  </div>
                </button>
              ...
              <div className="text-center pt-8">
                <button 
                  onClick={() => nextStep({ path: 'custom' })}
                  className="text-[9px] uppercase tracking-[0.5em] text-accent hover:text-ink transition-colors underline underline-offset-[12px] font-bold"
                >
          ...
          {state.step === 2 && state.path === 'branding' && (
            ...
            >
              <div className="space-y-4">
                <h2 className="font-serif text-4xl md:text-5xl text-ink">What is your brand's <br /><span className="italic font-light">core essence?</span></h2>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {[
                  { id: 'airy', label: 'Warm & Approachable', desc: 'Soft, connected, and community-focused.', img: 'https://images.unsplash.com/photo-1556761175-b413da4baf72?auto=format&fit=crop&q=80&w=800' },
                  { id: 'moody', label: 'Polished & Professional', desc: 'Sharp, high-end, and authoritative.', img: 'https://images.unsplash.com/photo-1497366216548-37526070297c?auto=format&fit=crop&q=80&w=800' }
                ].map((opt) => (
                  <button
                    key={opt.id}
                  ...
                  >
                    <img src={opt.img} alt={opt.label} className="w-full h-full object-cover opacity-60 group-hover:opacity-100 transition-all duration-700" referrerPolicy="no-referrer" />
                    ...
                    <div className="absolute inset-0 p-8 flex flex-col justify-end">
                      ...
                      <p className="text-sm text-paper/70">{opt.desc}</p>
                    </div>
                  </button>
                ))}
              </div>
          ...
          {state.step === 3 && state.path === 'branding' && (
            ...
            >
              <div className="space-y-4">
                <h2 className="font-serif text-4xl md:text-5xl text-ink">Where does your <br /><span className="italic font-light">brand live?</span></h2>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {[
                  { id: 'candid', label: 'In the details & the process', desc: 'Artisans, makers, and behind-the-scenes.', img: 'https://images.unsplash.com/photo-1522202176988-66273c2fd55f?auto=format&fit=crop&q=80&w=800' },
                  { id: 'classic', label: 'In the spotlight & the results', desc: 'Speakers, CEOs, and consultants.', img: 'https://images.unsplash.com/photo-1507679799987-c73779587ccf?auto=format&fit=crop&q=80&w=800' }
                ].map((opt) => (
                  <button
                    key={opt.id}
          ...
          {state.step === 4 && state.path === 'branding' && (
            ...
            >
              <div className="space-y-4">
                <h2 className="font-serif text-4xl md:text-5xl text-ink">What is the <br /><span className="italic font-light">desired reaction?</span></h2>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {[
                  { id: 'airy', label: 'I want them to feel connected', desc: 'Trust, empathy, and relationship-focused.', img: 'https://images.unsplash.com/photo-1519389950473-47ba0277781c?auto=format&fit=crop&q=80&w=600' },
                  { id: 'moody', label: 'I want them to feel impressed', desc: 'Expertise, luxury, and results-focused.', img: 'https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?auto=format&fit=crop&q=80&w=600' }
                ].map((opt) => (
                  <button
                    key={opt.id}
  ...
  return (
    <div className="min-h-screen bg-paper">
      ...
      <section className="pt-56 pb-32 px-6 text-center max-w-5xl mx-auto relative">
        {/* Decorative Element */}
        <div className="absolute top-40 left-1/2 -translate-x-1/2 font-serif text-[180px] opacity-[0.03] select-none pointer-events-none">
        ...
        <motion.div
          ...
          className="inline-flex items-center gap-3 px-6 py-2 rounded-full bg-accent/5 border border-accent/10 text-[9px] uppercase tracking-[0.4em] mb-12 text-accent font-bold"
        >
        ...
        <p className="text-xl md:text-2xl text-ink/50 font-light leading-relaxed mb-20 max-w-3xl mx-auto serif italic">
          {isBranding 
            ? `Your brand needs to look as high-end as the service you provide. We'll capture your authority with ${isAiry ? 'bright, clean' : 'dramatic, moody'} visuals that convert.`
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-32 max-w-4xl mx-auto">
          {[
            { label: 'Lighting', value: isAiry ? 'Luminous & Soft' : 'Dramatic & Rich' },
            { label: 'Direction', value: isCandid ? 'Guided Movement' : 'Editorial Posing' },
            { label: 'Palette', value: quizState.palette === 'moody' ? 'Deep Earth Tones' : 'Soft Neutrals' }
          ].map((item, i) => (
            <div key={i} className="space-y-3 p-8 rounded-[32px] border border-ink/5 bg-soft/30">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-8 max-w-7xl mx-auto">
          {images.map((img, i) => (
            <motion.div
              ...
              viewport={{ once: true }}
              className={`aspect-[3/4] rounded-[32px] overflow-hidden card-shadow ${i % 2 === 1 ? 'md:translate-y-12' : ''}`}
            >
              <img src={img} alt="Portfolio item" className="w-full h-full object-cover grayscale hover:grayscale-0 transition-all duration-1000" referrerPolicy="no-referrer" />
            </motion.div>
          ))}
        </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 max-w-6xl mx-auto">
            ...
            <div className="p-16 rounded-[48px] border border-ink/5 bg-paper space-y-12 relative overflow-hidden group card-shadow">
              ...
              <ul className="space-y-6 text-sm text-ink/60 font-light">
            ...
            <div className="p-16 rounded-[48px] bg-ink text-paper space-y-12 relative overflow-hidden card-shadow">
              ...
              <ul className="space-y-6 text-sm opacity-70 font-light">
  ...
  return (
    <section className="py-32 px-6 bg-paper">
      <div className="max-w-4xl mx-auto">
        ...
        {/* Quiz Summary Capsules */}
        {quizState && (
          <div className="mb-16 p-8 rounded-3xl border border-ink/5 bg-soft space-y-6 card-shadow">
            ...
            <div className="flex flex-wrap gap-3">
              {[
                ...
                { label: 'Lighting', value: quizState.lighting === 'airy' ? 'Bright & Airy' : 'Dark & Moody' },
                { label: 'Pose', value: quizState.poses === 'classic' ? 'Classic' : 'Candid' },
                { label: 'Palette', value: quizState.palette === 'moody' ? 'Deep Tones' : 'Pastels' }
              ].map((chip, i) => (
                <div key={i} className="px-4 py-2 rounded-full border border-ink/10 bg-white flex items-center gap-3">
        ...
        <form onSubmit={handleSubmit} className="space-y-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {(quizState?.path === 'branding' ? [
                ...
                <button
                  ...
                  className={`p-6 rounded-2xl border text-left transition-all card-shadow ${
                ...
                >
                  ...
                  <p className={`text-[10px] leading-relaxed uppercase tracking-wider ${formData.service === service.id ? 'text-paper/60' : 'text-ink/40'}`}>{service.desc}</p>
                </button>
              ))}
            </div>
          </div>
          ...
          <button 
            type="submit"
            className="w-full py-8 bg-ink text-paper rounded-full font-bold uppercase tracking-[0.2em] text-sm hover:scale-[1.01] transition-transform"
          >
            Send Inquiry
          </button>
        </form>
  ...
  <footer className="py-32 px-8 bg-paper border-t border-ink/5">
    <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-16">
      <div className="md:col-span-2 space-y-8">
        ...
        <p className="text-lg text-ink/40 font-light leading-relaxed max-w-sm serif italic">
      ...
      <div className="space-y-6">
        ...
        <ul className="space-y-4 text-[11px] uppercase tracking-[0.2em] text-ink/60 font-bold">
    ...
    <div className="max-w-7xl mx-auto mt-32 pt-12 border-t border-ink/5 flex flex-col md:flex-row justify-between items-center gap-6">
      <p className="text-[9px] uppercase tracking-[0.3em] text-ink/30 font-bold">© 2026 Ontario Photo Co. All rights reserved.</p>
      <div className="flex gap-8 text-[9px] uppercase tracking-[0.3em] text-ink/30 font-bold">
    ...
    <section className="py-48 px-8 bg-paper relative overflow-hidden">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-24 items-center">
        ...
        >
          ...
          <div className="space-y-8 text-xl text-ink/50 font-light leading-relaxed serif italic">
            <p>
        ...
        <motion.div 
          ...
          viewport={{ once: true }}
          className="relative aspect-[4/5] rounded-[60px] overflow-hidden card-shadow"
        >
          <img 
      ...
      <div className="max-w-7xl mx-auto space-y-32">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12">
          <div className="md:col-span-8 aspect-video rounded-[48px] overflow-hidden relative group card-shadow">
            <img src="https://images.unsplash.com/photo-1494790108377-be9c29b29330?auto=format&fit=crop&q=80&w=1200" alt="Portrait" className="w-full h-full object-cover grayscale group-hover:grayscale-0 transition-all duration-1000" referrerPolicy="no-referrer" />
            <div className="absolute inset-0 bg-ink/40 opacity-0 group-hover:opacity-100 transition-opacity flex items-end p-16">
              <div className="text-left space-y-4">
                <p className="text-[9px] uppercase tracking-[0.4em] text-paper/60 font-bold">Portrait Path</p>
          ...
          <div className="md:col-span-4 aspect-square md:aspect-auto rounded-[48px] overflow-hidden relative group card-shadow">
            <img src="https://images.unsplash.com/photo-1560250097-0b93528c311a?auto=format&fit=crop&q=80&w=600" alt="Branding" className="w-full h-full object-cover grayscale group-hover:grayscale-0 transition-all duration-1000" referrerPolicy="no-referrer" />
            <div className="absolute inset-0 bg-ink/40 opacity-0 group-hover:opacity-100 transition-opacity flex items-end p-12">
              <div className="text-left space-y-4">
                <p className="text-[9px] uppercase tracking-[0.4em] text-paper/60 font-bold">Branding Path</p>
                <h3 className="font-serif text-3xl italic text-paper">The Modern Visionary</h3>
              </div>
            </div>
          </div>
          <div className="md:col-span-4 aspect-square md:aspect-auto rounded-[48px] overflow-hidden relative group card-shadow">
            <img src="https://images.unsplash.com/photo-1511367461989-f85a21fda167?auto=format&fit=crop&q=80&w=600" alt="Creative" className="w-full h-full object-cover grayscale group-hover:grayscale-0 transition-all duration-1000" referrerPolicy="no-referrer" />
          </div>
          <div className="md:col-span-8 aspect-video rounded-[48px] overflow-hidden relative group card-shadow">
            <img src="https://images.unsplash.com/photo-1441974231531-c6227db76b6e?auto=format&fit=crop&q=80&w=1200" alt="Landscape" className="w-full h-full object-cover grayscale group-hover:grayscale-0 transition-all duration-1000" referrerPolicy="no-referrer" />
          </div>
        </div>
      </div>
    </section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-16">
          {[
            ...
            <motion.div 
              ...
              viewport={{ once: true }}
              className="space-y-8 p-12 rounded-[40px] border border-ink/5 bg-soft/30"
            >
              <span className="font-serif text-6xl italic text-accent opacity-20">{item.step}</span>
              <h3 className="text-2xl font-serif text-ink">{item.title}</h3>
              <p className="text-ink/50 font-light leading-relaxed serif italic">{item.desc}</p>
            </motion.div>
          ))}
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 max-w-5xl mx-auto">
          <div className="p-16 rounded-[48px] border border-ink/5 bg-paper space-y-8 card-shadow">
            ...
            <p className="text-ink/50 font-light leading-relaxed serif italic">Capturing personal milestones, family legacies, and individual stories across Ontario.</p>
          ...
          <div className="p-16 rounded-[48px] border border-ink/5 bg-paper space-y-8 card-shadow">
            ...
            <p className="text-ink/50 font-light leading-relaxed serif italic">Elevating professional identities for modern visionaries and creative entrepreneurs.</p>
